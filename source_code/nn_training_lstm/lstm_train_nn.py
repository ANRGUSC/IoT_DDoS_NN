...
def create_nn_model(input_shape, output_shape):
    ...
    model.add(tf.keras.layers.LSTM(10, activation='relu', input_shape=input_shape))
...
def main_plot_logs(k_list):
    ...
    Returns:
        ---
    """
    all_saved_models_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/current_features_aggregate_all_k/Output/saved_model/*"
...
def main_train_model(k_list):
    ...
    initial_model_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/current_features_aggregate_all_k/Output/initial_model/"
    ...
    model_output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/current_features_aggregate_all_k/Output/saved_model/"
