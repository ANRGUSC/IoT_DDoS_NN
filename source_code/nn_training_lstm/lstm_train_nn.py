...
def main_plot_logs(k_list):
    ...
    Returns:
        ---
    """
    all_saved_models_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/Output/saved_model/*"
...
def main_train_model(k_list):
    ...
    initial_model_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/Output/initial_model/"
    ...
    model_output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_lstm/Output/saved_model/"
