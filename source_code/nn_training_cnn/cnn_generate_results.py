...
def main_general_report(metric, mode, k_list, time_window):
    ...
    model_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/saved_model/"
    train_dataset = load_dataset(train_dataset_path)
    test_dataset = load_dataset(test_dataset_path)

    output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/report/"
...
def main_generate_attack_prediction_vs_time(metric, mode, k_list, time_window):
    ...
    model_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/saved_model/"
    output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_prediction_vs_time/data/"
...
def main_plot_attack_prediction_vs_time(metric, mode, k_list):
    ...
    Returns:
        --
    """
    train_output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_prediction_vs_time/plot/train/"
    test_output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_prediction_vs_time/plot/test/"
    prepare_output_directory(train_output_path)
    prepare_output_directory(test_output_path)

    train_result_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_prediction_vs_time/data/train_result_" + metric + '_' + mode + ".csv"
    test_result_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_prediction_vs_time/data/test_result_" + metric + '_' + mode + ".csv"
...
def main_plot_metric_vs_attack_parameter(metric, mode):
    ...
    Returns:
        --
    """
    mean_report_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/report/mean_report_" + metric + '_' + mode + ".csv"
    mean_report = pd.read_csv(mean_report_path)

    output_path = CONFIG.OUTPUT_DIRECTORY + "nn_training_cnn/Output/attack_vs_k/"
    prepare_output_directory(output_path)
