...
def generate_features(attacked_dataset_path, output_path, data_type, num_train_days, num_test_days):
    ...
    durations = {timedelta(seconds=0): "now",
    ...
    template_column = ["BEGIN_DATE", "END_DATE", "NUM_NODES", "ATTACK_RATIO", "ATTACK_DURATION", "ATTACK_PARAMETER",
                       "NODE", "TIME"]
...
def main_generate_features(data_type, num_train_days, num_test_days):
    ...
    path = CONFIG.OUTPUT_DIRECTORY + "pre_process/Output/attacked_data/" + data_type + "/*.csv"
